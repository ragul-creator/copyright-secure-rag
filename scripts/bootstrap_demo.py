...
for sid,name,file in [
 ...
 ("SRC-SHIPPING","Shipping Policy","shipping_policy.txt")]:
    register_source(SourceRegistration(source_id=sid,name=name,rights_holder="Example Corp",
    ...
    ingest_document(sid,"DOC-"+sid.split("-")[-1],(base/"sample_data"/file).read_text())
print("Demo sources registered and ingested.")
